...
{\*\expandedcolortbl;;}
\paperw11900\paperh16840\margl1440\margr1440\vieww11520\viewh9120\viewkind0
...
def get_treatment_info(class_name):\
    ...
    treatments = \{\
        ...
        'Potato___Late_blight': "\uc0\u9888 \u65039  Serious! Remove infected plants immediately. Apply fungicides containing chlorothalonil.",\
...
\
                ...
                if predicted_raw_name == 'Background_without_leaves':\
                    st.warning("\uc0\u9888 \u65039  No leaf detected. Please try a clearer image.")\
                else:\
                    display_name = clean_class_name(predicted_raw_name)\
                    st.success(f"Result: **\{display_name\}**")\
                    st.info(f"Confidence: \{confidence:.2f\}%")\
                    \
                    st.subheader("\uc0\u55357 \u56481  Recommendation")\
